...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "UPDATE usuarios SET dni = '$dni', nombres = '$nombres', apellido_paterno = '$apellido_paterno', 
              apellido_materno = '$apellido_materno', password = '$password', cargo = '$cargo', estado = '$estado' 
              WHERE id = $id";
                                    ...
                                    <form class="needs-validation" novalidate method="POST">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="password" name="password" value="<?php echo htmlspecialchars($usuario['password']); ?>" required>
                                            </div>
