...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql_update = "UPDATE pacientes SET dni = ?, nombres = ?, apellido_paterno = ?, apellido_materno = ?, programa_estudios = ?, semestre = ? WHERE id = ?";
    $stmt_update = $conn->prepare($sql_update);
    $stmt_update->bind_param("ssssssi", $dni, $nombres, $apellido_paterno, $apellido_materno, $programa_estudios, $semestre, $id);
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <select class="form-control mb-3" name="semestre" required>
                                                    <option disabled selected>Seleccionar</option>
                                                    <option value="I" <?php echo ($paciente['semestre'] == 'I') ? 'selected' : ''; ?>>I</option>
                                                    <option value="II" <?php echo ($paciente['semestre'] == 'II') ? 'selected' : ''; ?>>II</option>
                                                    <option value="III" <?php echo ($paciente['semestre'] == 'III') ? 'selected' : ''; ?>>III</option>
                                                    <option value="IV" <?php echo ($paciente['semestre'] == 'IV') ? 'selected' : ''; ?>>IV</option>
                                                    <option value="V" <?php echo ($paciente['semestre'] == 'V') ? 'selected' : ''; ?>>V</option>
                                                    <option value="VI" <?php echo ($paciente['semestre'] == 'VI') ? 'selected' : ''; ?>>VI</option>
                                                </select>
                                            </div>
                                        </div>
