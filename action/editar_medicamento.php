...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt->bind_param('ssssssssssi', $nombre, $presentacion, $marca, $cantidad, $fecha_vencimiento, $categoria, $laboratorio, $lote, $fecha_ingreso, $proveedor, $id);
                                    ...
                                    <form class="needs-validation" novalidate action="" method="POST">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-2 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="validationTooltip04" name="cantidad" value="<?php echo htmlspecialchars($medicamento['cantidad_ingreso']); ?>" required pattern="[1-9][0-9]*">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-3 mb-3">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <select class="form-control mb-3" name="categoria" required>
                                                    ...
                                                    <?php foreach ($categorias as $categoria): ?>
                                                        <option <?php if($categoria == $medicamento['categoria']) echo 'selected'; ?>><?php echo htmlspecialchars($categoria); ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <select class="form-control mb-3" name="laboratorio" required>
                                                    ...
                                                    <?php foreach ($laboratorios as $laboratorio): ?>
                                                        <option <?php if($laboratorio == $medicamento['laboratorio']) echo 'selected'; ?>><?php echo htmlspecialchars($laboratorio); ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                            <div class="col-md-2 mb-3">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="date" class="form-control" id="fecha_ingreso" name="fecha_ingreso" value="<?php echo htmlspecialchars($medicamento['fecha_ingreso']); ?>" required>
                                            </div>
                                            <div class="col-md-3 mb-3 ml-auto">
                                                ...
                                                <select class="form-control mb-3" name="proveedor" required>
                                                    ...
                                                    <?php foreach ($proveedores as $proveedor): ?>
                                                        <option <?php if($proveedor == $medicamento['proveedor']) echo 'selected'; ?>><?php echo htmlspecialchars($proveedor); ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
