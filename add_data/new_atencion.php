                                ...
                                <div class="card-body">
                                    ...
                                    <script>
                                                ...
                                                xhr.onload = function() {
                                                    if (xhr.status === 200) {
                                                        ...
                                                        if (result.success) {
                                                            ...
                                                            document.getElementById('semestre').value = result.semestre;
                                                        } else {
                                                            // Si no se encuentra el paciente
                                                            alert(result.message || 'No se encontró un paciente con ese DNI.');
                                        ...
                                        function guardarAtencion(event) {
                                            ...
                                            if (!dni || !nombres || !apellidos || !programaEstudios || !semestre || !procedimiento || !encargado || !fechaAtencion) {
                                            ...
                                            formData.append('programa_estudios', programaEstudios);
                                            ...
                                            xhr.onload = function() {
                                                ...
                                                if (xhr.status === 200) {
                                                    ...
                                                    if (response.success) {
                                                        ...
                                                        alert(response.message || "Hubo un error al guardar los datos.");
                                                    }
                                                } else {
                                                    alert("Error en la comunicación con el servidor.");
                                                }
