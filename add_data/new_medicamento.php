...
$laboratorios = [];
while ($medicamento = $resultado->fetch_assoc()) {
    $laboratorios[] = $medicamento['nombre'];
}
...
$proveedores = [];
while ($medicamento = $resultado->fetch_assoc()) {
    $proveedores[] = $medicamento['razon_social'];
}
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <select class="form-control mb-3" name="categoria" required>
                                                    ...
                                                    <?php foreach ($categorias as $categoria): ?>
                                                        <option><?php echo htmlspecialchars($categoria); ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <select class="form-control mb-3" name="laboratorio" required>
                                                    ...
                                                    <?php foreach ($laboratorios as $laboratorio): ?>
                                                        <option><?php echo htmlspecialchars($laboratorio); ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                            <div class="col-md-2 mb-3">
                                            ...
                                            <div class="col-md-3 mb-3 ml-auto">
                                                ...
                                                <select class="form-control mb-3" name="proveedor" required>
                                                    ...
                                                    <?php foreach ($proveedores as $proveedor): ?>
                                                        <option><?php echo htmlspecialchars($proveedor); ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
