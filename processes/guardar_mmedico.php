...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO mmedicamentos (nombre, presentacion, marca, cantidad_ingreso, fecha_vencimiento, categoria, laboratorio, lote, fecha_ingreso, proveedor)
              VALUES ('$nombre', '$presentacion', '$marca', '$cantidad', '$fecha_vencimiento', '$categoria', '$laboratorio', '$lote', '$fecha_ingreso', '$proveedor')";
