                    ...
                    m.laboratorio, m.lote, m.proveedor, m.cantidad_ingreso";
                                            ...
                                            if ($resultado->num_rows > 0):
                                                while ($medicamento = $resultado->fetch_assoc()):
                                                    ...
                                                    $stock = $medicamento['cantidad_ingreso'] - $medicamento['salida'];
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="btn btn-sm btn-danger" href="../action/eliminar_medicamento.php?id=<?php echo urlencode($medicamento['id']); ?>" title="Eliminar"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php endwhile; ?>
                                            <?php else: ?>
