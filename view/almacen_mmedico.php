...
$query = "SELECT id, nombre, presentacion, marca, cantidad_ingreso, fecha_vencimiento, categoria, laboratorio, lote, fecha_ingreso, proveedor FROM mmedicamentos";
    ...
    <div id="../layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="state-saving-datatable" class="table activate-select dt-responsive nowrap">
                                        ...
                                        <tbody>
                                            <?php
                                            // Consulta SQL para obtener los datos de la tabla mmedicamentos y calcular el stock
                                            $sql = "SELECT 
                    m.id, 
                    m.nombre, 
                    m.presentacion, 
                ...
                GROUP BY 
                    m.id, m.nombre, m.presentacion, m.categoria, m.marca, m.fecha_vencimiento, 
                    m.laboratorio, m.lote, m.proveedor, m.cantidad_ingreso";
                                            ...
                                            if ($resultado->num_rows > 0):
                                                while ($fila = $resultado->fetch_assoc()):
                                                    ...
                                                    $stock = $fila['cantidad_ingreso'] - $fila['salida'];
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-right"><?php echo htmlspecialchars($stock); ?></td> <!-- Aquí mostramos el stock -->
                                                        <td><?php echo htmlspecialchars($fila['fecha_vencimiento']); ?></td>
                                                        <td><?php echo htmlspecialchars($fila['laboratorio']); ?></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="btn btn-sm btn-danger" href="../action/eliminar_mmedico.php?id=<?php echo urlencode($fila['id']); ?>" title="Eliminar"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php endwhile; ?>
                                            <?php else: ?>
